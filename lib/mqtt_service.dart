...
class MQTTService {
  ...
  void initializeMQTTClient() {
    _client = MqttServerClient(host!, 'clientId-ur9ULKuJSk')
      ..port = port!
      ..logging(on: false)
    ...
    final connMess = MqttConnectMessage()
        ...
        .withWillTopic('sensor/home')
        .withWillMessage('testtesttesttesttesttesttesttesttesttesttesttesttesttesttesttest')
        .startClean()
